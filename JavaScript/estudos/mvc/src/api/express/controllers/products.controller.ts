...
import { ProductrepositoryPrisma } from "../../../repositories/product/prisma/product.repository";
import { prisma } from "../../../util/prisma.util";
import { PorductServiceImplemetation } from "../../../services/product/implementation/product.service.implementation";
...
export class ProductController {
    ...
    public async create(request: Request, response: Response) {
        ...
        const aService = PorductServiceImplemetation.build(aRepository);
